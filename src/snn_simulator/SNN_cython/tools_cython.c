...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "tools_cython",
        "sources": [
            "/home/olivier/Kent/PhD/Project/NSLC-SIM/src/snn_simulator/SNN_cython/tools_cython.pyx"
        ]
    },
    "module_name": "tools_cython"
}
END: Cython Metadata */
...
#define __PYX_HAVE__tools_cython
#define __PYX_HAVE_API__tools_cython
/* Early includes */
#include <sys/types.h>
#include <signal.h>
#include <sys/time.h>
...
/* Module declarations from "tools_cython" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "tools_cython"
extern int __pyx_module_is_main_tools_cython;
int __pyx_module_is_main_tools_cython = 0;

/* Implementation of "tools_cython" */
...
static double __pyx_f_12tools_cython_get_time(void) {
 ...
 */
  __pyx_r = (__pyx_v_ts.tv_sec + (((double)__pyx_v_ts.tv_nsec) / 1000000000.));
  goto __pyx_L0;
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("get_time", (void (*)(void))__pyx_f_12tools_cython_get_time, "double (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  __pyx_t_1 = PyModule_Create(&__pyx_moduledef); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to tools_cython pseudovariable */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_tools_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "tools_cython")) {
      if (unlikely((PyDict_SetItemString(modules, "tools_cython", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init tools_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init tools_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
